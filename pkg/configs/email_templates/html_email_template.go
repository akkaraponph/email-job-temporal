...
<head>
	...
	<title>Welcome to akkaraponph</title>
	<!--[if mso]>
	<style type="text/css">
							...
							<table role="presentation" width="100%" cellpadding="0" cellspacing="0">
								<tr>
									<td align="center" style="padding-bottom: 20px;">
										<img src="https://yt3.googleusercontent.com/PFmOY2nzI91G1-J6fSj_uVO0KmspprKjAbvMhA3vznSKMy-n3yG9eFDTSMLSYT0T1ELWJkPTLA=s176-c-k-c0x00ffffff-no-rj" alt="akkaraponph Logo" style="width: 120px; height: 120px; border-radius: 50%; border: 4px solid rgba(255, 255, 255, 0.3); display: block; margin: 0 auto;" />
									</td>
								</tr>
								<tr>
									<td align="center">
										<h1 style="margin: 0; color: #ffffff; font-size: 32px; font-weight: 700; letter-spacing: -0.5px; text-shadow: 0 2px 4px rgba(0, 0, 0, 0.2);">Welcome to akkaraponph</h1>
							...
							<table role="presentation" width="100%" cellpadding="0" cellspacing="0">
								<tr>
									<td>
										...
										<p style="margin: 0; color: #667eea; font-size: 16px; line-height: 1.8; font-weight: 600;">The akkaraponph Team</p>
									</td>
								</tr>
							</table>
						</td>
							...
							<table role="presentation" width="100%" cellpadding="0" cellspacing="0">
								<tr>
									<td align="center" style="padding-bottom: 15px;">
										<p style="margin: 0; color: #718096; font-size: 14px; line-height: 1.6;">&copy; 2024 akkaraponph. All rights reserved.</p>
									</td>
								</tr>
								<tr>
									<td align="center">
				...
				<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-top: 20px;">
					<tr>
						<td align="center" style="padding: 0 20px;">
							<p style="margin: 0; color: #a0aec0; font-size: 12px; line-height: 1.6;">This email was sent to you by akkaraponph</p>
						</td>
					</tr>
				</table>
			</td>
